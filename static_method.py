...
if __name__=="__main__":
	...
	print(data)
	aMLE,beta_list,r = sample.fitting(data,family=1,link="log",n=2000,loss_function = "MLE")
	print("決定係数:{}".format(r))
	sample.animation(data[0], beta_list)
	aLSE,beta_list,r = sample.fitting(data,family=1,link="log",n=50000,loss_function = "LSE")
	#a = sample.LSE(data)
	print("決定係数:{}".format(r))
	x = data[0]
